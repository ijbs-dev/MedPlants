...
<h3 class="text-5xl text-center font-normal leading-normal mt-8 mb-2 text-pink-800">
    Agendamentos
  </h3>
        ...
        <table class="min-w-full">
            <thead>
                <tr>
                    ...
                    <th class="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-blue-500 tracking-wider">Data</th>
                    <th class="px-6 py-3 border-b-2 border-gray-300"></th>

                </tr>
            </thead>
            <tbody class="bg-white">
                    @foreach ($agendaData['pets'] as $agenda)
                    <tr>
                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-500">
                            @php
                            $userId = $agenda->pet->user_id;
                        ...
                        <td class="px-6 py-4 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5">{{ $user->telefone }}</td>

                        </td>
                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-500 text-blue-900 text-sm leading-5">{{ $agendaData['pets'][$userId]->adoption_date }}</td>
                        <td class="px-6 py-4 whitespace-no-wrap text-right border-b border-gray-500 text-sm leading-5">
                            <button class="px-5 py-2 border-blue-500 border text-blue-500 rounded transition duration-300 hover:bg-blue-700 hover:text-white focus:outline-none">Confirmar</button>
                        </td>
                 </tr>
                 @endforeach
            </tbody>
